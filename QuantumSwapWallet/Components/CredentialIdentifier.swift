...
// live under `QuantumSwap-<deviceSuffix>`; backup-file
// credentials live under `QuantumSwap-backup-<address>-<deviceSuffix>`.
...
enum CredentialIdentifier {
    ...
    static var strongboxUsername: String {
        return "QuantumSwap-\(deviceSuffix)"
    }
    ...
    static func backupUsername(address: String) -> String {
        return "QuantumSwap-backup-\(address)-\(deviceSuffix)"
    }
    ...
    static var backupBatchUsername: String {
        return "QuantumSwap-backup-\(deviceSuffix)"
    }
}
