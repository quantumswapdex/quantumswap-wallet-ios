...
// Android reference:
// app/src/main/java/com/quantumswap/app/model/BlockchainNetwork.java
// app/src/main/java/com/quantumswap/app/utils/GlobalMethods.java (setActiveNetwork)
...
public final class BlockchainNetworkManager: @unchecked Sendable {
    ...
    //   - `QuantumSwapWallet/Schema/StrongboxFileCodec.swift` for the
