...
// Android reference:
// app/src/main/java/com/quantumswap/app/api/read/ApiClient.java
// app/src/main/java/com/quantumswap/app/api/read/api/AccountsApi.java
...
public final class ApiClient: @unchecked Sendable {
    ...
    //   - `QuantumSwapWallet/Utilities/Constants.swift` for the matching
    //     `_networkLock` pattern this code mirrors.
    //   - `QuantumSwapWallet/Data/BlockchainNetwork.swift`'s
...
// via `QuantumSwapAddress.isValid` and throws `.other(URLError(.badURL))`
