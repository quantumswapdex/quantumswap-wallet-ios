...
// bridge.html + quantumswap-bundle.js and brokers every call to the JS
// side. Exactly one instance per process - enforced by `shared`.
// Android reference:
// app/src/main/java/com/quantumswap/app/bridge/WebViewManager.java
...
public final class JsEngine: NSObject {
    ...
    private func createWebView() {
        ...
        // references is the local `quantumswap-bundle.js`).
...
/// Resolves `appassets://bridge.html` and `appassets://quantumswap-bundle.js`
...
/// legitimately needs: `bridge.html` and `quantumswap-bundle.js`.
...
// the previous URL shape was
        ...
        // - `appassets://bridge.html/quantumswap-bundle.js` (relative resolution)
        // - `appassets:///quantumswap-bundle.js` (root-relative, hypothetical)
...
fileprivate extension JSONEncoder {
    ...
    /// exact same characters that `QuantumSwapJSBridge.escapeForJs`
    /// escapes on Android.
