...
// Android reference:
// app/src/main/java/com/quantumswap/app/interact/JsonInteract.java
// app/src/main/java/com/quantumswap/app/viewmodel/JsonViewModel.java
...
public final class Localization {
    ...
    /// Generic langValues lookup used by DEX screens (Swap / Liquidity /
    /// Pools / Releases). Returns `fallback` when the key is missing.
